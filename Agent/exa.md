...
| Content | Full text |
**Project Description:** We are built a lot of Ai agents like travelling, coding and Student Resource and building ai for AI for which we required web search and others .
...
**Run in terminal:**
```bash
claude mcp add --transport http exa https://mcp.exa.ai/mcp?exaApiKey=c785a28d-514e-49e6-b823-6d4af99a12c8
```
...
```
https://mcp.exa.ai/mcp?exaApiKey=c785a28d-514e-49e6-b823-6d4af99a12c8&tools=web_search_exa,get_code_context_exa,people_search_exa
```

Enable all tools:
```
https://mcp.exa.ai/mcp?exaApiKey=c785a28d-514e-49e6-b823-6d4af99a12c8&tools=web_search_exa,web_search_advanced_exa,get_code_context_exa,crawling_exa,company_research_exa,people_search_exa,deep_researcher_start,deep_researcher_check
```

**Your API key:** `c785a28d-514e-49e6-b823-6d4af99a12c8`
